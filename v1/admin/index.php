            ...
            <main class="admin-main">
                ...
                <section class="admin-view" id="view-products">
                    <div class="view-heading order-page-heading">
                        ...
                        <div class="order-page-actions"><button class="secondary-button fit-button" id="import-filmilo-button" type="button">IMPORTAR FILMILO</button><button class="primary-button fit-button" id="new-product-button" type="button">NUEVO PRODUCTO</button></div>
                    </div>
