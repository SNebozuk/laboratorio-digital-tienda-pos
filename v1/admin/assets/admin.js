(() => {
    ...
    function renderDeliverySlots() {
        ...
        const suggestions = pending ? suggestedDeliverySlots(pending) : [];
    ...
    async function copyOrderToDelivery(orderId, slot) {
        try {
