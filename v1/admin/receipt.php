...
?>
<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="icon" href="../assets/favicon.png?v=20260826" type="image/png"><title><?= receiptText($batch ? 'Ventas seleccionadas' : $orders[0]['public_number']) ?></title><link rel="stylesheet" href="assets/receipt.css?v=<?= receiptText($assetVersion) ?>"></head><body>
