...
?>
<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Cotizador para Emprendedores · Laboratorio Digital</title><link rel="icon" href="<?= $escape($storePath) ?>/favicon.php" type="image/svg+xml"><link rel="stylesheet" href="<?= $escape($assetPath) ?>/quote.css?v=<?= $quoteAssetsVersion ?>"><link rel="stylesheet" href="<?= $escape($assetPath) ?>/quote-table.css?v=<?= $quoteAssetsVersion ?>"><link rel="stylesheet" href="<?= $escape($assetPath) ?>/quote-carousel.css?v=<?= $quoteAssetsVersion ?>"></head>
