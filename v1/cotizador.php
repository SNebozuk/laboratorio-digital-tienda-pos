...
<section class="quote-card"><div class="quote-step"><b>1</b><div><h2>Elegí tu papel</h2><p>Elegí entre los papeles disponibles en Laboratorio Digital.</p></div></div><button id="paper-picker" class="paper-picker" type="button" aria-expanded="false">Elegí el papel que más te guste <span>⌄</span></button><p id="paper-selected" class="paper-selected" hidden></p><div id="paper-picker-panel" class="paper-picker-panel" hidden><div id="paper-list" class="paper-list"><p>Cargando papeles…</p></div></div></section>
