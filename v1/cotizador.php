...
<section class="quote-card"><div class="quote-step"><b>1</b><div><h2>Elegí tu papel</h2><p>Elegí entre los papeles disponibles en Laboratorio Digital.</p></div></div><details id="paper-picker" class="paper-picker"><summary>Seleccioná un papel <span>⌄</span></summary><div id="paper-list" class="paper-list"><table class="paper-table"><thead><tr><th>Papel</th><th>Precio resma</th></tr></thead><tbody><?php foreach ($quotePapers as $paper): ?><tr data-id="<?= (int) $paper['variant_id'] ?>" data-product="<?= $escape((string) $paper['product_name']) ?>" data-variant="<?= $escape((string) $paper['variant_name']) ?>" data-price="<?= (int) $paper['price_cents'] ?>"><td><?= $escape((string) $paper['product_name']) ?></td><td>$ <?= number_format((int) $paper['price_cents'] / 100, 0, ',', '.') ?></td></tr><?php endforeach ?></tbody></table></div></details><p id="paper-selected" class="paper-selected" hidden></p></section>
