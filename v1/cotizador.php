...
<section class="quote-card"><div class="quote-step"><b>1</b><div><h2>Elegí tu papel</h2><p>Elegí entre los papeles disponibles en Laboratorio Digital.</p></div></div><details id="paper-picker" class="paper-picker"><summary>Elegí el papel que más te guste <span>⌄</span></summary><p id="paper-selected" class="paper-selected" hidden></p><div id="paper-list" class="paper-list"><table class="paper-table"><thead><tr><th>Papel</th><th>Precio resma</th></tr></thead><tbody><?php foreach ($quotePapers as $paper): ?><tr data-id="<?= (int) $paper['variant_id'] ?>"><td><input type="radio" name="quote-paper" value="<?= (int) $paper['variant_id'] ?>" aria-label="Elegir <?= $escape((string) $paper['product_name']) ?>"> <?= $escape((string) $paper['product_name']) ?><?= $paper['variant_name'] ? ' · ' . $escape((string) $paper['variant_name']) : '' ?></td><td>$ <?= number_format((int) $paper['price_cents'] / 100, 0, ',', '.') ?></td></tr><?php endforeach ?></tbody></table></div></details></section>
