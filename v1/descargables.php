...
<body class="downloads-page">
    ...
    <main class="downloads-shell">
        ...
        <section class="downloads-grid" aria-label="Archivos descargables">
            <article class="download-card"><div><h2>Mochila para colorear · verde</h2><p>Una mochilita para colorear, ideal para llenar de golosinas y regalar.</p><a href="<?= $escape($assetPath) ?>/downloads/mochila-verde.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><div><h2>Mochila para colorear · rosa</h2><p>Una versión alternativa de la mochilita para imprimir, colorear y regalar.</p><a href="<?= $escape($assetPath) ?>/downloads/mochila-rosa.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><div><h2>Llaveros para San Valentín</h2><p>Diseños de llaveros para crear un regalo especial.</p><a href="<?= $escape($assetPath) ?>/downloads/llaveros-san-valentin.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><div><h2>Cartas a Santa</h2><p>Cartas y sobres listos para imprimir y preparar los deseos de Navidad.</p><a href="<?= $escape($assetPath) ?>/downloads/cartas-a-santa.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
        </section>
    </main>
