...
<body class="downloads-page">
    ...
    <main class="downloads-shell">
        ...
        <section class="downloads-grid" aria-label="Archivos descargables">
            ...
            <article class="download-card"><img src="<?= $escape($assetPath) ?>/downloads/buzon-santa-preview-1.jpg" alt="Buzón de Santa"><div><h2>Buzón de Santa</h2><p>Plantilla para armar un buzón navideño.</p><a href="<?= $escape($assetPath) ?>/downloads/buzon-santa.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><img src="<?= $escape($assetPath) ?>/downloads/calendario-2026-preview-1.jpg" alt="Calendario 2026"><div><h2>Calendario 2026</h2><p>Calendario listo para imprimir.</p><a href="<?= $escape($assetPath) ?>/downloads/calendario-2026.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><img src="<?= $escape($assetPath) ?>/downloads/dia-amigo-preview-1.jpg" alt="Día del amigo"><div><h2>Día del amigo</h2><p>Diseño para celebrar y regalar.</p><a href="<?= $escape($assetPath) ?>/downloads/dia-amigo.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><img src="<?= $escape($assetPath) ?>/downloads/semana-dulzura-preview-1.jpg" alt="Semana de la dulzura"><div><h2>Semana de la dulzura</h2><p>Diseño especial para dulces y regalos.</p><a href="<?= $escape($assetPath) ?>/downloads/semana-dulzura.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><img src="<?= $escape($assetPath) ?>/downloads/animalitos-canvas-preview-1.jpg" alt="Animalitos con canvas"><div><h2>Animalitos con canvas</h2><p>Figuras para imprimir, recortar y armar.</p><a href="<?= $escape($assetPath) ?>/downloads/animalitos-canvas.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><img src="<?= $escape($assetPath) ?>/downloads/anotador-estudiante-preview-1.jpg" alt="Anotador día del estudiante"><div><h2>Anotador día del estudiante</h2><p>Diseño de anotador para regalar.</p><a href="<?= $escape($assetPath) ?>/downloads/anotador-estudiante.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><img src="<?= $escape($assetPath) ?>/downloads/bienvenida-reyes-preview-1.jpg" alt="Bienvenida para los Reyes Magos"><div><h2>Bienvenida para los Reyes Magos</h2><p>Cartel de bienvenida para imprimir.</p><a href="<?= $escape($assetPath) ?>/downloads/bienvenida-reyes.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><img src="<?= $escape($assetPath) ?>/downloads/bolsita-visor-preview-1.jpg" alt="Bolsita con visor"><div><h2>Bolsita con visor</h2><p>Plantilla de bolsita para armar.</p><a href="<?= $escape($assetPath) ?>/downloads/bolsita-visor.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><img src="<?= $escape($assetPath) ?>/downloads/bolsita-estampitas-preview-1.jpg" alt="Bolsita para estampitas"><div><h2>Bolsita para estampitas</h2><p>Packaging para recuerdos y estampitas.</p><a href="<?= $escape($assetPath) ?>/downloads/bolsita-estampitas.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
            <article class="download-card"><img src="<?= $escape($assetPath) ?>/downloads/cajita-bruma-preview-1.jpg" alt="Cajita con Bruma Clara"><div><h2>Cajita con Bruma Clara</h2><p>Plantilla de caja para imprimir y armar.</p><a href="<?= $escape($assetPath) ?>/downloads/cajita-bruma.pdf" download><span>↓</span> DESCARGAR PDF</a></div></article>
        </section>
    </main>
