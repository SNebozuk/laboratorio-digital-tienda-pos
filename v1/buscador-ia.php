...
<head>
    ...
    <title>Asesor IA · Laboratorio Digital</title>
            ...
            <div class="ai-search-layout">
                <section class="ai-search-chat settings-card" aria-label="Búsqueda de productos">
                    <div class="ai-search-messages" id="ai-search-messages">
                        <div class="ai-search-message ai-search-message-assistant"><small>ASESOR IA</small><p>¡Hola! Soy el Asesor IA de Laboratorio Digital. ¿En qué te ayudo?</p></div>
                    </div>
