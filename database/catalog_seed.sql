...
SELECT c.id, '10 UNIDADES PIN SUBLIMABLE POLYMER MUG', 'Dimensiones: 5 cm de diametro Espesor : 2.5 mm Color: Blanco Temperatura y tiempo de sublimación: 180° 40 seg Área de estampado: 4.5 cm de diametro Superf...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/pin-e3bbf9dbea020d7061169938726148331-f617f7687ccb5ed56a16993872719856-1024-1024.jpg', 1, 0
FROM categories c
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'AGENDA MADERA CRISTAL - CR225', 'Agenda A5 perpetua para sublimar Medidas:• 15,5 cm x 22 cm Cantidad:• Bolsa x1 unidad Incluye: • Tapa y contratapa sublimables• 50 hojas personalizadas • Ani...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/cuaderno-2494924ae1211a7eb017708218564617-1024-1024.webp', 1, 1
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'ALHAJERO MADERA CRISTAL - CR21', 'Dimensiones: 8cm x 8cm x 4.5cm Espesor : 2.5 mm Color: Blanco Temperatura y tiempo de sublimación: 180° 30 seg Área de estampado: completo Superficie bri...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/alhajero-5eeb7f3ec80383e04e17211443416302-1024-1024.webp', 1, 2
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'APOYA CELULAR MADERA CRISTAL - CR37', 'Dimensiones: 16 cm alto x 7.5 cm de ancho x 14 profundidad Espesor: 2.5 mm Color: Blanco Temperatura y tiempo de sublimación: 180° 30 seg Área de estam...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/apoya-celular-1-4f8de18c370a8c87bb17171697573036-1024-1024.webp', 1, 3
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'ARGOLLA METÁLICA PARA LLAVES - 10 UNIDADES', 'Argolla metálica redonda ideal para sujetar llaves con cierre sencillo. Compacta y durable, perfecta para uso diario. ¡Consigue la tuya ahora!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/shopping-8654526a790aa2124017690493835394-1024-1024.webp', 1, 0
FROM categories c
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'ATRIL POSAVASOS MADERA - CR43', '10 cm - no sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/atril-posavaso1-939812099a7bce2c3d15544705552622-1024-1024.webp', 1, 4
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'AZUCARERA - YERBERA POLYMER MUG SUBLIMABLE', 'Dimensiones: 13,5 cm de alto x 8 cm de diámetro Espesor: 3 mm Color: Blanco Temperatura y tiempo de sublimación: 180º 180 segundos Área de estampado: 21 cm x...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/yerbera1-f3868e09005533b68115664207504732-1024-1024.webp', 1, 5
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BANDEJA A4 MADERA CRISTAL - CR32D', 'Dimensiones: 21 cm alto x 29 cm de ancho x 4.5 profundidad ( A3 ) Espesor: 2.5 mm Color: Blanco Temperatura y tiempo de sublimación: 180° 30 seg Área de ...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/bandeja-a411-ce2b4879d40936cc2215544706300024-1024-1024.webp', 1, 6
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BILLETERA MUJER NEGRO', 'Dimensiones abierta 31 cm x 20 cm Area sublimable 18 cm x 10 cm simil neoprene. Color negro "falso charol"', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/billetera-dama-negro1-07d4113f9247ee6a6415988930137453-1024-1024.webp', 1, 7
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BOLSA FRISELINA 15X20', 'termosellada ultrasonido color blanco dimensiones 15 cm x 20 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/bolsa-friselina-15x201-815445fdf5bea48bfa15569150484028-1024-1024.webp', 1, 8
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BOLSA FRISELINA 20X30', '80 g termosellada ultrasonido color blanco dimensiones 30 cm x 20 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/bolsa-chica-friselina1-11668feb7a8f1df86515571748519508-1024-1024.webp', 1, 9
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BOLSA FRISELINA 30X30', 'termosellada ultrasonido color blanco dimensiones 35 cm x 30 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/bolsa-friselina-30x301-bcdd8eb46731b4065715571746972070-1024-1024.webp', 1, 10
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BOLSA FRISELINA 30X40', 'termosellada ultrasonido color blanco dimensiones 30 cm x 40 cm + 10 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/bolsa-friselina11-14dac7f45d2b3f61f915544886109773-1024-1024.webp', 1, 11
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BOLSA FRISELINA 45X40', '80 g termosellada ultrasonido color blanco dimensiones 45 cm x 40 cm + 10 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/bolsa-friselina1-14dac7f45d2b3f61f915544885599894-1024-1024.webp', 1, 12
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BOTELLA CORDON SUBLIMABLE', 'Aluminio sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-17-jul-2026-14_44_47-0b6834860ff4943c0d17843104398361-1024-1024.webp', 1, 13
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BOTELLA TERMICA SUBLIMABLE', 'Aluminio sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-17-jul-2026-14_44_51-eccad82cec59a6679717843104250400-1024-1024.webp', 1, 14
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BUZO CANGURO FRIZA CLASICA - NEGRO', 'Comprá online BUZO CANGURO FRIZA CLASICA - NEGRO por $16.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/canguro-negro-clasico-hombre-frente-e0dcbf07a8665545b817483745360165-1024-1024.webp', 1, 0
FROM categories c
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BUZO CUELLO REDONDO FRIZA CLASICA - BLANCO', 'aptos para estampar y DTF', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-9-mar-2026-10_09_36-be2bb326d08bdd813017730617859173-1024-1024.webp', 1, 1
FROM categories c
WHERE c.name = 'BUZOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BUZO CUELLO REDONDO FRIZA CLASICA - GRIS MELANGE', 'aptos para estampar y DTF', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/gemini_generated_image_w0kbgow0kbgow0kb-75aebc4fe1846b366a17730683677036-1024-1024.webp', 1, 2
FROM categories c
WHERE c.name = 'BUZOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'BUZO CUELLO REDONDO FRIZA CLASICA - NEGRO', 'Comprá online BUZO CUELLO REDONDO FRIZA CLASICA - NEGRO por $14.900. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/cuello-redondo-negro-hombre-frente-07be87a6c720112c9017483765973055-1024-1024.webp', 1, 3
FROM categories c
WHERE c.name = 'BUZOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CAJA DE TE MADERA CRISTAL - CR29D', 'madera cristal sublimable 15 cm x 15 cm x 8.5 cm con tapa', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/cajon-multiuso-x41-4bd8ec47d0e29c192715659727681546-1024-1024.webp', 1, 15
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CAJA TAZA CARTON SUBLIMABLE', 'carton sublimable 10 cm x 10 cm x 10 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/caja-de-carton-sublimable1-f0ba147878d658e3ad15544681551252-1024-1024.webp', 1, 16
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CAJA TAZA VENTANA CARTON SUBLIMABLE', 'Comprá online CAJA TAZA VENTANA CARTON SUBLIMABLE por $600. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/caja-de-carton-2-ventana-sublimable-fe7239f67fd74e8f1817154383085793-1024-1024.webp', 1, 17
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CAJITA FELIZ CARTON SUBLIMABLE', 'Comprá online CAJITA FELIZ CARTON SUBLIMABLE por $400. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/cajita-feliz-392de5cc16cbb6061417707532865615-1024-1024.webp', 1, 18
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CAMPERA FRIZA CLASICA - NEGRO', 'Dimensiones de Sisa a Sisa Los talles podrian variar entre 1 y 2 centimetros, se recomienda chequear en el local antes de retirar Talle 1: 53cm x 62cm Talle ...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/campera-negra-hombre-c60b69a62d510580e217501840960912-1024-1024.webp', 1, 4
FROM categories c
WHERE c.name = 'BUZOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CARTEL FORMA MADERA CRISTAL - CR23', '11 cm x 25 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/cartel-con-forma1-28c1b79d95331700f615544707273588-1024-1024.webp', 1, 19
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CARTON BRILLANTE A3 SUBLIMABLE', 'carton 350g para tapas de cuadernos agendas carteles etc dimensiones 42 cm x 29,7 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/carton-sublimable11-f8dc3b6a4d039369eb15544684598433-1024-1024.webp', 1, 20
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CARTON BRILLANTE A4 SUBLIMABLE - BLANCO', 'carton 350g para tapas de cuadernos agendas carteles etc dimensiones 29,7 cm x 21 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/carton-sublimable1-f8dc3b6a4d039369eb15544683411116-1024-1024.webp', 1, 21
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CHOP CERVECERO POLYMER MUG SUBLIMABLE', 'Comprá online CHOP CERVECERO POLYMER MUG SUBLIMABLE por $5.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chop-plastico-ca7b81231243a5a65e17715966180691-1024-1024.webp', 1, 22
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CINTA TERMICA WORKAT SUPERMIAU - 10MM', 'La podés aplicar en remeras, tazas, gorras o cualquier otro objeto sublimable! 30 metros Resisten altas temperaturas: Supermiau 200°', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/10-mm-99023afdbe8d418f3517648585920200-1024-1024.webp', 1, 1
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CINTA TERMICA WORKAT SUPERMIAU - 5MM', 'La podés aplicar en remeras, tazas, gorras o cualquier otro objeto sublimable! 30 metros Resisten altas temperaturas: Supermiau 200°', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/5mm-4b8a59067262d40e7317648585025767-1024-1024.webp', 1, 2
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'COMO SUBLIMAR FRISELINA', '👜 Cómo sublimar friselina La friselina es uno de los materiales más delicados para sublimar. Por eso, la clave no está tanto en la temperatura, sino ...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/imagen-de-whatsapp-2025-08-25-a-las-12-39-34_95e6f7e8-ec323134b2ef6ebbed17561365200536-1024-1024.webp', 1, 0
FROM categories c
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'CONFORMADOR TAZA POLYMER MUG', 'Comprá online CONFORMADOR TAZA POLYMER MUG por $1.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/conformador-mdf-1-c85afa50f08a28913717715965957656-1024-1024.webp', 1, 3
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'DESTAPADOR DE PARED MADERA CRISTAL - CR82', 'Destapador de pared Dimensiones: 25 cm alto x 10 cm de ancho Espesor: 2.5 mm Color: Blanco Temperatura y tiempo de sublimación: 180° 30 seg Área de estam...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/destapador-pared1-278fadd0c440478c0115949866850756-1024-1024.webp', 1, 24
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'FILMILO ACETATO BRUMA CLARA A4 ARTJET', 'Acetato esmerilado translúcido (Bruma Clara) para impresoras inkjet. Formato A4, perfecto para lograr efectos de transparencia suave en invitaciones, sobres y proyectos creativos de alta gama.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/acetato-bruma-clara-84ffd0f6a72dbf256f17582117631810-1024-1024.webp', 1, 0
FROM categories c
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'FILMILO ACETATO VIDRIO FINO A4 ARTJET', 'Acetato transparente flexible de 120 micrones para impresoras inkjet fotográficas. Ideal para cajas, etiquetas y proyectos decorativos. Alta calidad de imagen y resistencia a la torsión.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/acetato-vidrio-fino-4bd989c4292288b61517582129495126-1024-1024.webp', 1, 2
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'FILMILO ADHESIVO A4 BLANCO FRIO ARTJET', 'Film autoadhesivo color blanco frío para impresoras inkjet. Formato A4, perfecto para etiquetas con colores vibrantes y negros profundos. Ideal para señalética, stickers y personalización de alta calidad.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/filmilo-blanco-frio-068aa9d244e31656bf17582105619023-1024-1024.jpg', 1, 4
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'FILMILO ADHESIVO A4 NIEBLA TRANSLUCIDA ARTJET', 'Film autoadhesivo con acabado esmerilado (Niebla Traslúcida) para impresoras inkjet. Formato A4, ideal para calcomanías decorativas, señalética en vidrio y etiquetas con efecto mate difuso.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/filmilo-niebla-traslucida-5913863fb20c0a43c317582139108026-1024-1024.webp', 1, 9
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GANCHOS ABROCHADORA 26/06 PLATA', 'En el Atelier donde cada hoja encuentra su lugar perfecto… nacen las Grampas 26/06 📎✨ Pensadas para el ritmo cotidiano, combinan practicidad y...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/caja-de-grampas-y-piramide-de-metal-8e23d081537d3a4f4217746267340175-1024-1024.webp', 1, 4
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GLITERINA ADORIE AZUL A4 - 20 HOJA G4', 'Gliterina: ¡brillo que inspira creatividad! ?HOJAS A4 Sumergite en un mundo de alegría y color con Gliterina, la línea de papeles con glitter que transforma ...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/azul-b9a1bfcf26a4b75efb17782519644195-1024-1024.webp', 1, 13
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GLITERINA ADORIE BRONCE A4 - 20 HOJAS G3', 'Gliterina: ¡brillo que inspira creatividad! ?HOJAS A4 Sumergite en un mundo de alegría y color con Gliterina, la línea de papeles con glitter que transforma ...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/bronce-86f323e950c0313bae17398001843157-1024-1024.webp', 1, 14
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GLITERINA ADORIE VERDE OLIVA A4 - 20 HOJAS G31', 'Gliterina: ¡brillo que inspira creatividad! ?HOJAS A4 Sumergite en un mundo de alegría y color con Gliterina, la línea de papeles con glitter que transforma ...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/verde-oliva-889af6e0d8d0406b0717398027146304-1024-1024.webp', 1, 15
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA GABARDINA FRANCIA', 'Gorra tipo béisbol de 6 gajos en color blanco de gabardina, ideal para personalizar con estampados, DTF o bordados. Este modelo no se sublima, lo que la conv...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-13-feb-2026-20_32_56-1c55fabeb767fdaf1317710255797227-1024-1024.webp', 1, 0
FROM categories c
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - AMARILLO BLANCO AMARILLO', 'vicera y red amarillo - frente blanco sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/trucker-amarillo-blanco1-5ddf0a899f964dde4d15544687562484-1024-1024.webp', 1, 1
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - AMARILLO BLANCO MARINO', 'Comprá online GORRA TRUCKER - AMARILLO BLANCO MARINO por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/amarillo-blanco-marino-b5f501aa2aa9ee31b517710247862709-1024-1024.webp', 1, 2
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - CELESTE BLANCO CELESTE', 'Comprá online GORRA TRUCKER - CELESTE BLANCO CELESTE por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/gorra-trucker-celeste-blanco-8b63ba7c86a73375c717709919233068-1024-1024.webp', 1, 3
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - FRANCIA BLANCO FRANCIA', 'Comprá online GORRA TRUCKER - FRANCIA BLANCO FRANCIA por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/trucker-azul-blanco-4319cab53b6f2324b717709910341919-1024-1024.webp', 1, 4
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - FRANCIA FRANCIA FRANCIA', 'Comprá online GORRA TRUCKER - FRANCIA FRANCIA FRANCIA por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/gorra-trucker-azul-francia1-993161f819187f77d916109391881867-1024-1024.webp', 1, 5
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - FUCSIA BLANCO FUCSIA', 'vicera y red fucsia - frente blanco sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/trucker-fucsia-blanco1-82719650a01f04351815544692492087-1024-1024.webp', 1, 6
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - GRIS GRIS GRIS', 'Comprá online GORRA TRUCKER - GRIS GRIS GRIS por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/gorra-trucker-gris-76bc0164995603c9bb17635703480499-1024-1024.webp', 1, 7
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - NEGRO NEGRO NEGRO', 'Comprá online GORRA TRUCKER - NEGRO NEGRO NEGRO por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/gorra-trucker-negra1-06c7fa33d724a2bf1215544700719120-1024-1024.webp', 1, 8
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - ROJO BLANCO NEGRO', 'Comprá online GORRA TRUCKER - ROJO BLANCO NEGRO por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/gorra-trucker-negro-blanco-rojo-06c05089c05b8c406f17709921192558-1024-1024.webp', 1, 9
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - ROJO BLANCO ROJO', 'vicera sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/trucker-rojo-blanco1-bd4da7de948830b22b15544702255367-1024-1024.webp', 1, 10
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - ROJO ROJO ROJO', 'Comprá online GORRA TRUCKER - ROJO ROJO ROJO por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/trucker-rojo1-e1fea69d693a9f787b16109392548520-1024-1024.webp', 1, 11
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER INFANTIL - AMARILLO BLANCO AMARILLO', 'Comprá online GORRA TRUCKER INFANTIL - AMARILLO BLANCO AMARILLO por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/trucker-amarillo-blanco1-5ddf0a899f964dde4d15703933015251-1024-1024.webp', 1, 12
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER INFANTIL - MARINO BLANCO MARINO', 'Comprá online GORRA TRUCKER INFANTIL - MARINO BLANCO MARINO por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/gorra-trucker-infantl-marino1-eb194f200be8b49d9916073031989380-1024-1024.webp', 1, 13
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER INFANTIL - NEGRO NEGRO NEGRO', 'Comprá online GORRA TRUCKER INFANTIL - NEGRO NEGRO NEGRO por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/gorra-trucker-negra1-06c7fa33d724a2bf1215703933363770-1024-1024.webp', 1, 14
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER INFANTIL - ROJO BLANCO NEGRO', 'Comprá online GORRA TRUCKER INFANTIL - ROJO BLANCO NEGRO por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-13-feb-2026-20_20_47-4802bd7e74bf46ca5617710248649933-1024-1024.webp', 1, 15
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER INFANTIL - ROJO BLANCO ROJO', 'vicera y red fucsia - frente blanco', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/gorra-trucker-rojo-blanco-infantil1-6901dee5007a4e2a7316057106796924-1024-1024.webp', 1, 16
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'HOLOFAN ADHESIVO A4 DISCO DANCE ARTJET - H17', '? Qué es Holofan Art-Jet Holofan es una línea de tramas adhesivas holográficas de la marca Art-Jet, diseñada para elevar tus proyectos de impresión con efect...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/disco-dance-a5c09a26f7d837f22a16989344644140-1024-1024.webp', 1, 20
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'HOLOFAN ADHESIVO A4 RAFAGA DE AMOR ARTJET - H15', '? Qué es Holofan Art-Jet Holofan es una línea de tramas adhesivas holográficas de la marca Art-Jet, diseñada para elevar tus proyectos de impresión con efect...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/rafaga-de-amor-71389b54a8f3d2251a16989346853186-1024-1024.webp', 1, 29
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'HOLOFAN ADHESIVO A4 ROCIO DE OTOO ARTJET - H08', '? Qué es Holofan Art-Jet Holofan es una línea de tramas adhesivas holográficas de la marca Art-Jet, diseñada para elevar tus proyectos de impresión con efect...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/rocio-de-otono-0a88ee3d9f47880e0d16989349620042-1024-1024.webp', 1, 30
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'HOLOFAN ADHESIVO A4 TELARAA DE CAMPO ARTJET - H07', '? Qué es Holofan Art-Jet Holofan es una línea de tramas adhesivas holográficas de la marca Art-Jet, diseñada para elevar tus proyectos de impresión con efect...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/telarana-cc48b3dc8a1761e3f116989350093615-1024-1024.webp', 1, 31
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'HOLOFAN ADHESIVO A4 TORNADO PSICODELICO ARTJET - H14', '? Qué es Holofan Art-Jet Holofan es una línea de tramas adhesivas holográficas de la marca Art-Jet, diseñada para elevar tus proyectos de impresión con efect...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/tornado-104ac1178a9a425d2c16989347194748-1024-1024.webp', 1, 32
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'HOPPY 500CC POLYMER MUG SUBLIMABLE', 'Para sublimar en 360 tener en cuenta que el primer estampado se hace en 180/180 y el resto de hacen en 60 segundos', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/hoppy-polymer1-3211289f4771e8388816036697458659-1024-1024.webp', 1, 25
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'HOPPY DOBLE TAPA SUBLIMABLE', 'Aluminio sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-17-jul-2026-14_45_06-59ef81c1f45264100e17843103533031-1024-1024.webp', 1, 26
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'JARRO TERMICO POLYMER MUG SUBLIMABLE', 'Dimensiones: 24 cm de alto x 8 cm de diámetro Capacidad: 450cc Espesor: 4 mm Color: Blanco Temperatura y tiempo de sublimación: 180º 180 segundos Área de est...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/jarro-termico1-becd9f5a25f71d43cb16853631347199-1024-1024.webp', 1, 27
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO 40X60 POLIMERO SUBLIMABLE', '40 mm x 60 mm 4 mm de espesor Incluye Argolla', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/40x60-rect1-09b26a9ea6aa75ac4d15544809711381-1024-1024.webp', 1, 28
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO ABU MADERA CRISTAL - CR66D', 'Medida: 6 cm x 4 cm Incluye argolla', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/llavero-abu-604cdc0d9882798fdb17181169621921-1024-1024.webp', 1, 29
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO CAMISETA MADERA CRISTAL - CR03D', 'Medida: 5 cm x 5 cm Incluye argolla', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/llavero-camiseta-5e444bbf21906405ae17181170039875-1024-1024.webp', 1, 30
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO CIRCULO 20 UNIDADES MADERA CRISTAL - CR02', '5 cm incluye arandela', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/llavero-circulo1-7d0f620dc7740289ec15675352213428-1024-1024.webp', 1, 31
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO CIRCULO POLYMER MUG SUBLIMABLE', '4 cm diametro 4 mm de espesor Incluye Argolla', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/circulo1-e129d56c8285b0b03a15544813555927-1024-1024.webp', 1, 32
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO CORAZON 20 UNIDADES MADERA CRISTAL - CR277D', '6 x 5.5cmincluye arandela y refuerzo plastico', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-27-feb-2026-10_55_48-d8a7ba60a05f80e0c317722005547669-1024-1024.webp', 1, 33
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO CORAZON MADERA CRISTAL - CR277D', 'Medida: 7 cm x 7 cm Material: Madera Cristal MDF de espesor 3mm Venta por 20 unidades Incluye Arandela...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/llavero-corazon-20cbb1df88cde1bb9f17138807345444-1024-1024.webp', 1, 34
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO CUADRADO 20 UNIDADES MADERA CRISTAL - CR01', '5 cm x 5 cm incluye arandela y refuerzo plastico', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/whatsapp-image-2026-02-13-at-8-10-34-pm-124c7e83abcc2bfaf017710243145824-1024-1024.webp', 1, 35
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO DESTAPADOR POLIMERO SUBLIMABLE', '40 mm x 70mm 4 mm de espesor Incluye Argolla', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/destapador1-4d7bcf382590b9bb6615662205547247-1024-1024.webp', 1, 36
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO HUESO CHICO POLYMER MUG SUBLIMABLE', '40 x 20 mm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/hueso-chico1-93c772f38ccd7860bb15544815004645-1024-1024.webp', 1, 37
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO HUESO GRANDE POLYMER MUG SUBLIMABLE', '40 mm x 60 mm 4 mm de espesor Incluye Argolla', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/huesito1-6095521b9c7b4c147716100222651553-1024-1024.webp', 1, 38
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO MARIPOSA 20 UNIDADES MADERA CRISTAL - CR278D', '6 x 5.5cmincluye arandela y refuerzo plastico', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-27-feb-2026-10_51_20-9ec3de9d2fac10b03f17722003198439-1024-1024.webp', 1, 39
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO MARIPOSA MADERA CRISTAL - CR278D', '6cm x 5cm + Argolla', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/llavero-mariposa-da141b8f48440bdd3017105310369160-1024-1024.webp', 1, 40
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO MATE MADERA CRISTAL - CR216', 'Medidas 3,5 x 7cm incluye argolla', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/llavero-mate1-4c33d5782d63d8e2cd16838128798807-1024-1024.webp', 1, 41
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'LLAVERO PAPA MADERA CRISTAL - CR65D', 'Medida: 6 cm x 4 cm incluye arandela', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/llavero-papa-aaa-ae011eff61c55c2ef117181171314023-1024-1024.webp', 1, 42
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATE LISTO POLYMER MUG SUBLIMABLE', 'Mate listo para sublimar - incluye bombilla - conserva la temperatura Dimensiones: 19 cm de alto x 8 cm de diámetro Capacidad: 450 cc Espesor: 4 mm Color: B...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/mate-listo-nuevo1-399dcb73ebd992cb4d15901660557362-1024-1024.webp', 1, 43
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATE POLIMERO SUBLIMABLE WORKAT - ROSA', 'Comprá online MATE POLIMERO SUBLIMABLE WORKAT - ROSA por $3.600. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-15-abr-2026-13_03_55-82f06b59af1d24c75617762690399733-1024-1024.webp', 1, 44
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATE POLYMER MUG SUBLIMABLE - ACCESORIO NEGRO', 'Incluye Accesorio', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/whatsapp-image-2026-01-28-at-3-34-36-pm-343aae74291473ebde17696254937985-1024-1024.webp', 1, 45
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA A3 200G ARTJET - 20 HOJAS', 'Comprá online MATELINA A3 200G ARTJET - 20 HOJAS por $6.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-200g-a3-20-hojas1-6f32d667ea788366fd16311331678393-1024-1024.webp', 1, 33
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA A4 130G ARTJET - 100 HOJAS', 'Comprá online MATELINA A4 130G ARTJET - 100 HOJAS por $9.300. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-130g-simple-faz-100-hojas1-5beb4a1d89973c978d16311324533531-1024-1024.webp', 1, 34
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA A4 150G ARTJET - 100 HOJAS', 'Comprá online MATELINA A4 150G ARTJET - 100 HOJAS por $10.500. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-150g-simple-faz-100-hojas-0d351a44032cb658aa17436843157300-1024-1024.webp', 1, 35
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA A4 180G ARTJET - 100 HOJAS', 'Comprá online MATELINA A4 180G ARTJET - 100 HOJAS por $13.200. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-180g-simple-faz-100-hojas1-3bbc07933ee9d6c18d16311328864490-1024-1024.webp', 1, 36
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA A4 230G ARTJET - 100 HOJAS', 'Comprá online MATELINA A4 230G ARTJET - 100 HOJAS por $14.500. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-230g-simple-faz-100-hojas1-cc3c25bf5eb28974a016311334107233-1024-1024.webp', 1, 38
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA ADHESIVO A4 108G ARTJET - 100 HOJAS', 'Comprá online MATELINA ADHESIVO A4 108G ARTJET - 100 HOJAS por $21.200. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-108g-mate-autoadhesivo-751b000b57f34d2f3217163871833837-1024-1024.webp', 1, 39
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA DOBLE FAZ A4 180G ARTJET - 50 HOJAS', 'Comprá online MATELINA DOBLE FAZ A4 180G ARTJET - 50 HOJAS por $7.700. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-180g-doble-faz-50-hojas1-8c388b594e186c63e316311329318509-1024-1024.webp', 1, 40
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA TEXTURADO A4 230G CORTEZA DE PINO ARTJET - 50 HOJAS', 'Comprá online MATELINA TEXTURADO A4 230G CORTEZA DE PINO ARTJET - 50 HOJAS por $11.600. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-185g-corteza-de-pino-50-hojas1-feb128d7b0e1acefaa17296963135723-1024-1024.jpg', 1, 42
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA TEXTURADO A4 230G CUERINA CLASICA ARTJET - 50 HOJAS', 'Comprá online MATELINA TEXTURADO A4 230G CUERINA CLASICA ARTJET - 50 HOJAS por $11.600. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-230g-cuerina-clasica-50-hojas1-e202f32f6bd1a10ddd17296961181788-1024-1024.jpg', 1, 43
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA TEXTURADO A4 230G LINO NATURAL ARTJET - 50 HOJAS', 'Comprá online MATELINA TEXTURADO A4 230G LINO NATURAL ARTJET - 50 HOJAS por $11.600. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-185g-lino-natural-50-hojas1-ad1a60ed92fb991efd17296960461804-1024-1024.jpg', 1, 44
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA TEXTURADO A4 230G NOGAL EUROPEO ARTJET - 50 HOJAS', 'Comprá online MATELINA TEXTURADO A4 230G NOGAL EUROPEO ARTJET - 50 HOJAS por $11.600. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-230g-nogal-europeo-50-hojas1-ab394c6316f2763f8617296962004391-1024-1024.jpg', 1, 45
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA TEXTURADO A4 230G TEJIDO DE LANA ARTJET - 50 HOJAS', 'Comprá online MATELINA TEXTURADO A4 230G TEJIDO DE LANA ARTJET - 50 HOJAS por $11.600. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-14-jul-2026-01_41_02-p-m-3cd24b20fcb995668b17840472744361-1024-1024.webp', 1, 46
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA TEXTURADO A4 230G TELAR NORTEÑO ARTJET - 50 HOJAS', 'Comprá online MATELINA TEXTURADO A4 230G TELAR NORTEÑO ARTJET - 50 HOJAS por $11.600. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-185g-telar-norteno-50-hojas-ff7edc004ef8fe665d17576907856232-1024-1024.webp', 1, 47
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MEDIAS DE FUTBOL SUBLIMABLES', 'Medias deportivas de poliester. Planta color negro y caña blanca sublimable T2: Planta del pie 18cm caña 21cm . Del 20 al 29 T3: Planta del pie 20cm caña 28...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/medias-futbol1-19800e75443581c8e216175875069938-1024-1024.webp', 1, 46
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'METALINA ADORIE DESTELLO A4 - 10 HOJAS', '- Paquetes de 10 hojas en formato A4✨ La línea de papeles metalizados que transforma y realza tus ideas ✨ 💡 Perfectos para todos tus pr...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/destello-d122bbd301b51bfc6a17720272185054-1024-1024.webp', 1, 48
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'METALINA ADORIE ORO MONEDA A4 - 10 HOJAS', '- Paquetes de 10 hojas en formato A4✨ La línea de papeles metalizados que transforma y realza tus ideas ✨ 💡 Perfectos para todos tus pr...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/oro-moneda-568acf6629998b45bd17720271235570-1024-1024.webp', 1, 49
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'METALINA ADORIE TORNASOL A4 - 10 HOJAS', '- Paquetes de 10 hojas en formato A4✨ La línea de papeles metalizados que transforma y realza tus ideas ✨ 💡 Perfectos para todos tus pr...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/tornasol-1ed649778a8193112317720272070831-1024-1024.webp', 1, 50
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MOUSE PAD SUBLIMABLE REDONDO 19CM', 'Dimensiones abierta 31 cm x 20 cm Area sublimable 18 cm x 10 cm simil neoprene. Base color gris', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/mouse-pad-redondo-d5f6c81db973407e1d17710256403019-1024-1024.webp', 1, 47
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPEL FOOGRAFICO MAGNETICO - IMANTADO - 1 HOJA', 'Papel fotográfico brillante magnético para Inkjet, material ferroso muy flexible y de poco espesor, esto facilita la carga en la toma de hoja. Compatible con...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/magnetico-52887722ed9e0a967d17702166449095-1024-1024.webp', 1, 51
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPEL FOTOGRAFICO A3 200G ARTJET - 20 HOJAS', 'Papel fotográfico brillante (Glossy) tamaño A3 de 200g ArtJet. Calidad premium para impresoras inkjet, secado instantáneo y gran formato. Ideal para láminas, posters y presentaciones.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-200g-a32-90f79b16fe5104015a15935568041812-1024-1024.webp', 1, 53
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
-- PAPEL FOTOGRAFICO A3+ 200G ARTJET - 20 HOJAS
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPEL FOTOGRAFICO A3+ 200G ARTJET - 20 HOJAS', 'Papel fotográfico brillante (Glossy) tamaño A3 de 200g ArtJet. Calidad premium para impresoras inkjet, secado instantáneo y gran formato. Ideal para láminas, posters y presentaciones.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-200g-a311-af8acbe4f770f204ed15935568519346-1024-1024.webp', 1, 54
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPEL FOTOGRAFICO A4 200G ARTJET - 20 HOJAS', 'Papel fotográfico brillante (Glossy) tamaño A4 de 200g ArtJet. Secado instantáneo y máxima resolución para impresoras inkjet. Ideal para fotos, catálogos y presentaciones.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/200g-x1001-f2e95371eb8321d97715888605329208-1024-1024.webp', 1, 60
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPEL FOTOGRAFICO DOBLE FAZ A4 120G ARTJET - 100 HOJAS', 'Papel fotográfico brillante (Glossy) Doble Faz tamaño A4 de 120g ArtJet. Secado instantáneo en ambas caras. Ideal para folletos, catálogos y presentaciones de alta resolución.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/a4-artjet-120g-doble-faz1-73d8ac59abb8eaf92816525554375023-1024-1024.webp', 1, 65
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPEL FOTOGRAFICO TEXTURADO A4 230G CANVAS CORTEZA DE PINO ARTJET - 50 HOJAS', 'Papel fotográfico con textura Canvas Corteza de Pino de 230g para impresoras inkjet. Formato A4, ideal para reproducciones artísticas, diplomas y tarjetas con un acabado rústico y elegante.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/corteza-de-pino-71e44fe8a267755f8c17586532551747-1024-1024.webp', 1, 66
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPEL FOTOGRAFICO TEXTURADO A4 230G CANVAS LINO NATURAL ARTJET - 50 HOJAS', 'Papel fotográfico con textura Lino Natural de 230g para impresoras inkjet. Formato A4, ideal para reproducciones de arte, tarjetería fina y presentaciones con un acabado textil elegante.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/lino-natural-26943d3aedbc4f148f17098079655028-1024-1024.webp', 1, 67
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPEL FOTOGRAFICO TEXTURADO A4 230G CANVAS TELAR NORTEÑO ARTJET - 50 HOJAS', '¡Ahora tus proyectos pueden parecer pinturas al óleo, creando una sensación artística única! La textura de Canvas agrega profundidad y dimensión a tus imágen...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-14-jul-2026-01_38_33-p-m-77940f47ccd14c020917840471391765-1024-1024.webp', 1, 70
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPEL SUBLIMACION COLOR UP 95% A4 ARTJET - 100 HOJAS', 'PAPELES DE ALTA TRANSFERENCIA Papel encapado específicamente para sublimar, transfiere mas del 95% de la tinta. Resultados inmejorables, con colores vivos y ...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/color-up-a4-d5743d39a1c352f23017577752911445-1024-1024.webp', 1, 72
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPELINA ADORIE A4 AMARILLO FLUO 180G - 20 HOJAS P22', 'Comprá online PAPELINA ADORIE A4 AMARILLO FLUO 180G - 20 HOJAS P22 por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/amarillo-fluo-53cc853a624d593cb817296944828995-1024-1024.webp', 1, 74
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPELINA ADORIE A4 BLANCO TIZA 180G - 20 HOJAS P01', 'Comprá online PAPELINA ADORIE A4 BLANCO TIZA 180G - 20 HOJAS P01 por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/imagen_800x800-b2f06e7dc2cbacfe5817769727676786-1024-1024.webp', 1, 75
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPELINA ADORIE A4 FUCSIA CHIC 180G - 20 HOJAS P17', 'Comprá online PAPELINA ADORIE A4 FUCSIA CHIC 180G - 20 HOJAS P17 por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/fucsia-chic-f306b2dcf8fa38f2d017296946523650-1024-1024.webp', 1, 76
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPELINA ADORIE A4 GRIS PIEDRA 180G - 20 HOJAS P05', 'Comprá online PAPELINA ADORIE A4 GRIS PIEDRA 180G - 20 HOJAS P05 por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/gris-piedra-3d7fe18ce32bb81e4f17296947262103-1024-1024.webp', 1, 77
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPELINA ADORIE A4 MARRON CAFE 180G - 20 HOJAS P12', 'Comprá online PAPELINA ADORIE A4 MARRON CAFE 180G - 20 HOJAS P12 por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/marron-cafe-be0b08fdcc88dc393d17296948447074-1024-1024.webp', 1, 78
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPELINA ADORIE A4 NARANJA CARAMELO 180G - 20 HOJAS P20', 'Comprá online PAPELINA ADORIE A4 NARANJA CARAMELO 180G - 20 HOJAS P20 por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/naranja-caramelo-fee890ec5accf038cc17296948582201-1024-1024.webp', 1, 79
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPELINA ADORIE A4 ROJO TOMATE 180G - 20 HOJAS P19', 'Comprá online PAPELINA ADORIE A4 ROJO TOMATE 180G - 20 HOJAS P19 por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/rojo-tomate-5c6984d9fa6df2232517296948870449-1024-1024.webp', 1, 80
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPELINA ADORIE A4 VERDE INGLES 180G - 20 HOJAS P07', 'Comprá online PAPELINA ADORIE A4 VERDE INGLES 180G - 20 HOJAS P07 por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/verde-ingles-dffbb067381307e9fe17296949516379-1024-1024.webp', 1, 81
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPELINA ADORIE A4 VERDE PRIMAVERA 180G - 20 HOJAS P09', 'Comprá online PAPELINA ADORIE A4 VERDE PRIMAVERA 180G - 20 HOJAS P09 por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/verde-primavera-1e8a4ea55e651c2ed617296949794965-1024-1024.webp', 1, 82
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAPELINA ADORIE A4 VERDE SELVA 180G - 20 HOJAS P08', 'Comprá online PAPELINA ADORIE A4 VERDE SELVA 180G - 20 HOJAS P08 por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/verde-selva-ad0bd4192fbb70712217296949933335-1024-1024.webp', 1, 83
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAR DE CANILLERAS - INFANTIL', 'Medidas 16 cm x 9 cm Excelentes canilleras sublimables, confeccionadas con plástico anti impacto, goma y tela sublimable. Se entregan con forma plana para su...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/canillera-infantil1-da17ecfc6e80884eb015794433173833-1024-1024.webp', 1, 48
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PAR DE CANILLERAS - JUVENIL', 'Medidas 19 cm x 10,5 cm Excelentes canilleras sublimables, confeccionadas con plástico anti impacto, goma y tela sublimable. Se entregan con forma plana pa...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/canillera-junior1-e03d5e257c0d4137ef15794434292745-1024-1024.webp', 1, 49
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PLACA 20X29 MADERA CRISTAL - CR47', '3 mm espesor 20 cm x 29 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/placa-2029-b84ba88303e653aa4617708220914964-1024-1024.webp', 1, 50
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PLATO 15 CM POLYMER MUG SUBLIMABLE', 'Ala y Centro Sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-20-ene-2026-15_56_26-c2f735a05f3468020817689354143840-1024-1024.webp', 1, 51
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PLATO 20 CM POLYMER MUG SUBLIMABLE', 'Centro Sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-20-ene-2026-16_03_02-ab990a6d2bc582562c17689358113048-1024-1024.webp', 1, 52
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PORTA LLAVES MADERA CRISTAL - CR11D', 'Medidas: 20 x 11 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/porta-llaves-e236be290d82b3849517181169298953-1024-1024.webp', 1, 53
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PORTA RETRATO 13X18 CORAZONES MADERA CRISTAL - CR378D', 'marco 13 cm x 18 cm3 corazones calados', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/13x18-corazones-312361de9d1820974617407513533521-1024-1024.webp', 1, 54
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PORTA RETRATO AMOR MADERA CRISTAL - CR73', '27 cm x 15 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/amor1-defd98cf2a1a2fd9c115544728279951-1024-1024.webp', 1, 55
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PORTA ROLLO MADERA CRISTAL - CR90D', 'Dimensiones: 11 cm alto x 22 cm de ancho Espesor: 2.5 mm Color: Blanco Temperatura y tiempo de sublimación: 180° 30 seg Superficie brillante, colores nít...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/portarollo-d192cd976437a0f86117690214224594-1024-1024.webp', 1, 56
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PORTA TAZA CARTON SUBLIMABLE', 'carton sublimable 19 cm x 14,3 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/caja-portataza1-eb420fba1bafdcedd415544685799562-1024-1024.webp', 1, 57
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PORTARETRATO FELIZ DIA MADERA CRISTAL - CR51', 'con pie 12.5 cm x 15 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/feliz-dia1-40b4776d69edf4820a15544850003927-1024-1024.webp', 1, 58
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'POSAVASO CIRCULO MADERA CRISTAL - CR09', '10 cm X 10cm No incluye atril precio por unidad', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/830c1f9c-7dbf-4bd4-ad4a-319218f35cdf_nube-153598525cdffc7dd615921358328076-1024-1024.webp', 1, 59
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'POSAVASO CUADRADO MADERA CRISTAL - CR08', '10 cm X 10cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/d83426f3-89b2-4ec4-88eb-8816a6a376ac_nube-50e360018f4a572ea115921358458468-1024-1024.webp', 1, 60
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA INFANTIL ALGODON PEINADO 24.1 - AMARILLO', 'Remera amarilla infantil de algodón peinado 24.1. Calidad premium ideal para estampar con DTF y serigrafía. Color intenso, tela suave y no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/a9ae5b8b-d0db-4e83-837e-97f21c0bd971-6c035af01f3f08517617576049861641-1024-1024.webp', 1, 1
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA INFANTIL ALGODON PEINADO 24.1 - AZUL MARINO', 'Remera azul marino infantil de algodón peinado 24.1. Calidad premium ideal para estampar con DTF y serigrafía. Excelente terminación y suavidad. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-20-nov-2025-17_01_05-20d394d169d94d0ba517636688801647-1024-1024.webp', 1, 2
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA INFANTIL ALGODON PEINADO 24.1 - BLANCO', 'Remera blanca infantil de algodón peinado 24.1. Calidad premium ideal para estampar con DTF, serigrafía y aplicaciones textiles. Tela suave que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/blanco-49e7d71ac1a713141117558741468196-1024-1024.webp', 1, 3
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA INFANTIL ALGODON PEINADO 24.1 - CELESTE', 'Remera celeste infantil de algodón peinado 24.1. Calidad premium ideal para estampar con DTF y serigrafía. Tela fresca, suave y resistente que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/peinado-inf-celester-20d76bc20a7f48009c17611620552140-1024-1024.webp', 1, 4
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA INFANTIL ALGODON PEINADO 24.1 - LILA', 'Remera lila infantil de algodón peinado 24.1. Calidad premium ideal para estampar con DTF, serigrafía y bordado. Textura suave que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/6432ce18-6992-462e-938d-94f11b307537-7ae72f0397359e5e7317636683263910-1024-1024.webp', 1, 6
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA INFANTIL ALGODON PEINADO 24.1 - NEGRO', 'Remera negra infantil de algodón peinado 24.1. Calidad premium ideal para estampar con DTF y serigrafía. Algodón de alta gama que mantiene el color y no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/negro-487a7475d8e17dfa3d17558741154342-1024-1024.webp', 1, 7
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA INFANTIL ALGODON PEINADO 24.1 - ROJO', 'Remera roja infantil de algodón peinado 24.1. Calidad premium ideal para estampar con DTF y serigrafía. Color intenso, tacto suave y tela que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/rojo-e64f4bee6d4297aaaa17557447182691-1024-1024.webp', 1, 8
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA INFANTIL ALGODON PEINADO 24.1 - ROSA', 'Remera rosa infantil de algodón peinado 24.1. Calidad premium ideal para estampar con DTF, serigrafía y bordado. Tela suave de alta durabilidad que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/peinado-inf-rosa-5a2fd584abfc939e4217611616023376-1024-1024.webp', 1, 9
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA INFANTIL ALGODON PEINADO 24.1 - VERDE', 'Remera verde infantil de algodón peinado 24.1. Calidad premium ideal para estampar con DTF y serigrafía. Tela resistente que mantiene el color y no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/peinado-nino-verde-ee8f8a4bfb0cd4d2da17611601846928-1024-1024.webp', 1, 10
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA INFANTIL JERSEY DEPORTIVO SUBLIMABLE - BLANCO', 'Remera blanca infantil de set deportivo (poliéster) ideal para sublimación. Tela técnica de secado rápido, fresca y resistente. Calidad premium para indumentaria escolar o deportiva.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/jersey-infantil-blanco-5e3a8ab173eb9c8c3f17612260176626-1024-1024.webp', 1, 11
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA INFANTIL RANGLAN SPUM - BLANCO/VERDE', 'Remera ranglan infantil blanca con mangas verde. Confeccionada en Spum, la tela ideal para sublimar diseños coloridos y duraderos. Calidad premium para uso escolar y recreativo.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/remera-infantil-ranglan-verde-61385579cc2ce38c6317160469951416-1024-1024.webp', 1, 14
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA MUJER ALGODON PEINADO 24.1 - NEGRO', 'Remera negra de mujer en algodón peinado 24.1 premium. Ideal para estampar con DTF y serigrafía. Excelente calce, tela que no achica y tacto suave. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/remera-mujer-negro1-767362ce3b3786d20c16559241175236-1024-1024.webp', 1, 17
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA MUJER MODAL - GRIS MELANGE', 'Remera gris melange para mujer confeccionada en modal de alta calidad. Tela suave, elástica y perfecta para sublimación. Un básico versátil con excelente caída para uso diario o marcas.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/remera-mujer-gris1-a5407b5d412142f79816626636893212-1024-1024.webp', 1, 18
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON MERCERIZADO - GRIS MELANGE', 'Remera gris melange unisex de algodón mercerizado de alta gama. Textura sedosa, brillo sutil y máxima durabilidad. Ideal para marcas exclusivas, DTF y bordados. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/algodon-mercerizado-gris-fb8e1f75de5d764ea517298835079942-1024-1024.webp', 1, 19
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON PEINADO 20.1 - NEGRO', 'Remera negra unisex de algodón 20.1 Deluxe. Tejido de alto gramaje con excelente cuerpo y resistencia. No se deforma y mantiene el color. Ideal para marcas premium, DTF y bordado.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-20-feb-2026-14_32_56-dbdff0b59d591ab07a17716087937433-1024-1024.webp', 1, 20
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON PEINADO 24.1 - AMARILLO', 'Remera amarilla unisex de algodón peinado 24.1 premium. Ideal para estampar con DTF, serigrafía y bordado. Color vibrante, calce clásico y tela que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-4-nov-2025-16_24_55-fd9400ce339092739d17622843308739-1024-1024.webp', 1, 21
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON PEINADO 24.1 - AZUL FRANCIA', 'Remera azul francia unisex de algodón peinado 24.1 premium. Ideal para estampar con DTF, serigrafía y bordado. Color intenso, calce clásico y tela que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/peinado-francia-d938aef19656a1572617557438868223-1024-1024.webp', 1, 22
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON PEINADO 24.1 - BLANCO', 'Remera blanca unisex de algodón peinado 24.1 premium. La base ideal para estampar con DTF, serigrafía y bordado. Calce clásico, tela fresca y duradera que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/peinado-blanco-b928a36cca54faefc317611458160998-1024-1024.webp', 1, 23
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON PEINADO 24.1 - BORDO', 'Remera bordó unisex de algodón peinado 24.1 premium. Ideal para estampar con DTF, serigrafía y bordado. Calce clásico, tela suave y no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-12-feb-2026-14_11_14-36b2aa5b118e28c87017709162838356-1024-1024.webp', 1, 24
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON PEINADO 24.1 - FUCSIA', 'Remera fucsia unisex de algodón peinado 24.1 premium. Ideal para estampar con DTF, serigrafía y bordado. Color vibrante, calce clásico y tela que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/peinado-fucsia-5cac9f0e930bf2f67e17611447715531-1024-1024.webp', 1, 25
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON PEINADO 24.1 - MARRON', 'Remera marrón unisex de algodón peinado 24.1 premium. Ideal para estampar con DTF, serigrafía y bordado. Calce clásico, tela suave y no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-12-feb-2026-14_12_47-8ee0a7fdcd805baaf417709163740715-1024-1024.webp', 1, 27
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON PEINADO 24.1 - NEGRO', 'Remera negra unisex de algodón peinado 24.1 premium. Calidad superior, ideal para estampar con DTF, serigrafía y bordado. Calce clásico y tela resistente que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/remera-adulto-negra1-e038cd3bb35254632717159555606152-1024-1024.jpg', 1, 28
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON PEINADO 24.1 - ROJO', 'Remera roja unisex de algodón peinado 24.1 premium. Ideal para estampar con DTF, serigrafía y bordado. Color vibrante y duradero, calce clásico y tela que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/peinado-rojo-ed07e743b3cbf3618017611473071763-1024-1024.webp', 1, 29
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON PEINADO 24.1 - ROSA', 'Remera rosa unisex de algodón peinado 24.1 premium. Ideal para estampar con DTF, serigrafía y bordado. Calce clásico, tela suave de alta calidad y no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/rosa-92ee6255dae992869b17557437903106-1024-1024.webp', 1, 30
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX ALGODON PEINADO 24.1 - VERDE MILITAR', 'Remera verde militar unisex de algodón peinado 24.1 premium. Ideal para estampar con DTF, serigrafía y bordado. Calce clásico, color resistente y tela que no achica. ¡Envíos a todo el país!', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-4-nov-2025-16_24_57-3e29f8f830cb76f8cf17622843776238-1024-1024.webp', 1, 32
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX JERSEY DEPORTIVO - NEGRO', 'Poliester técnico, flexible y de secado ultrarrápido. Usado en ropa deportiva profesional y prendas de alto rendimiento. Gran fidelidad de colores y resist...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-6-abr-2026-16_53_23-aac5aba78fe2af559117755052115418-1024-1024.webp', 1, 35
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'REMERA UNISEX MODAL - BLANCO', 'Remera blanca unisex de modal de alta calidad. Tela suave, elástica y con el blanco ideal para lograr sublimaciones con colores vibrantes y definidos. Un básico esencial para personalizadores.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-6-may-2026-09_50_16-5c6ea299c5907246b717780718270914-1024-1024.webp', 1, 36
FROM categories c
WHERE c.name = 'REMERAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'RESMA A4 AUTOR 90G - 500 HOJAS', 'Comprá online RESMA A4 AUTOR 90G - 500 HOJAS por $9.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/6c91af91-4022-4937-9cd2-2773739e0e49-22cee8a700f3939c3817848208679188-1024-1024.webp', 1, 84
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'RESMA A4 BOREAL 80G - 500 HOJAS', 'Comprá online RESMA A4 BOREAL 80G - 500 HOJAS por $8.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/a4-resma-boreal-500-hojas-80g1-72502bfdce6671315b16031328381685-1024-1024.webp', 1, 85
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'RESMA A4 PAMPA 70G 500 HOJAS', 'PAPEL A4 PAMPA 500 HOJAS 70G Para todo tipo de fotocopiadoras e impresoras. Tamaño: A4 (210 mm x 297 mm) Cantidad: 500 hojas Gramaje: 70g', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/resma-papel-pampa-a4-70g1-74530afa66a37603d014952032375115-1024-1024.webp', 1, 86
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'RESMA A4 PAMPA 75G - 500 HOJAS', 'Para todo tipo de fotocopiadoras e impresoras. Tamaño: A4 (210 mm x 297 mm) Cantidad: 500 hojas Gramaje: 75g', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/resma-papel-pampa-a4-751-f46aa58c8a9819b0e416178114416825-1024-1024.webp', 1, 87
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'ROMPECABEZAS 6 PIEZAS MADERA CRISTAL - CR14', 'Dimensiones: 20 cm alto x 29 cm de ancho Espesor : 2.5 mm Color: Blanco Temperatura y tiempo de sublimación: 180° 30 seg Área de estampado: completo Super...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/rompecabeza-6-5fa41c0292143f012417674497594001-1024-1024.webp', 1, 61
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'SACABOCADOS REDONDO 38MM ADORIE', 'Grandes formas para ideas grandes. Ideales para proyectos que necesitan presencia: carteles, decoración, packaging creativo o composiciones en capas. Firmes,...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-29-jul-2026-05_11_12-p-m-c88e73a50a89fcc35517853558833518-1024-1024.webp', 1, 5
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'SACABOCADOS REDONDO 50MM ADORIE', 'Grandes formas para ideas grandes. Ideales para proyectos que necesitan presencia: carteles, decoración, packaging creativo o composiciones en capas. Firmes,...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/sacabocado-rendondo-50mm-9cfc1409c3b671aeef17720474016181-1024-1024.webp', 1, 6
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TATETI MADERA CRISTAL - CR17', 'incluye 3 fichas sublimables cuadradas y 3 redondas Dimensiones: 14.5 cm alto x 14.5 cm de ancho Espesor : 2.5 mm Color: Blanco Temperatura y tiempo de sub...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/tateti-aec4fe5367c09aa73a17279865203164-1024-1024.webp', 1, 62
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TATUFAN ARTJET - 1 HOJA', 'Tatufan A4 Kit especial para crear tatuajes temporales y decoración de uñas, compuesto por un papel imprimible Inkjet y un papel de transferencia. Permite ob...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/tatufan1-9d9dd9723f605cb8d717541628275269-1024-1024.jpg', 1, 88
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TATUFAN ARTJET - 10 HOJAS', 'Tatufan A4Kit especial para crear tatuajes temporales y decoración de uñas, compuesto por un papel imprimible Inkjet y un papel de transferencia. Permite obt...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/tatufan1-88e357314de0efd8bc17847261901531-1024-1024.jpg', 1, 89
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TATUFAN: ¿QUÉ ES Y CÓMO USARLO?', '🔹 ¿Qué es Tatufan? El Tatufan es un papel especial de transferencia que te permite hacer tatuajes temporales personalizados. Se aplica sobre la piel ...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/whatsapp-image-2025-08-25-at-3-22-08-pm-014dff5cd3daf0b23217561462533202-1024-1024.webp', 1, 2
FROM categories c
WHERE c.name = 'APRENDE' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TAZA CERAMICA GLITTER COMBINADA ROSA/CELESTE', '9,5 cm de alto x 8 cm de diámetro4 mm de espesorSon sublimables', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/glitter-degrade-rosa-celeste-1-b762745968323f253617634029385818-1024-1024.webp', 1, 63
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TAZA CERAMICA IMPORTADA AAA', 'Comprá online TAZA CERAMICA IMPORTADA AAA por $4.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/taza-import-cbd98c3e88c2b008ae17111552871269-1024-1024.webp', 1, 64
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TAZA CERAMICA INTERIOR NEGRO', '9,5 cm de alto x 8 cm de diámetro 4 mm de espesor', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/interior-asa-negro-933f3d9a72aaa297b717683313675384-1024-1024.webp', 1, 65
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TAZA CERAMICA INTERIOR ROJO', '9,5 cm de alto x 8 cm de diámetro 4 mm de espesor', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/interior-asa-roja-b11ab20d644b63fb2117849003719759-1024-1024.webp', 1, 66
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
-- TAZA MÁGICA
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TAZA MÁGICA', 'Comprá online TAZA MÁGICA por $5.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/taza-magica1-306909d1aba97ef3de16830394058236-1024-1024.webp', 1, 67
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TAZA MÁGICA INTERIOR NEGRO', 'Comprá online TAZA MÁGICA INTERIOR NEGRO por $6.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/taza-magica-int-color-negro-d65720c0a86e15288717849002933329-1024-1024.webp', 1, 68
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TAZA MIMO POLIMERO SUBLIMABLE WORKAT', 'Altura : 8cm Apilables *NOS ENCANTA QUE TE ENCANTE*', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/mimo-blanca-1-b1e34a114eb62b8a7b17840470085235-1024-1024.webp', 1, 69
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TAZA MUCHI POLIMERO SUBLIMABLE WORKAT', 'Altura : 8cm Apilables *NOS ENCANTA QUE TE ENCANTE*', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-8-jun-2026-11_30_35-a-m-077c772ec4831be69617809291168269-1024-1024.webp', 1, 70
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TAZA POLIMERO SUBLIMABLE WORKAT', 'Altura: 8cmApilables*NOS ENCANTA QUE TE ENCANTE*todos los productos Workat son libres de BPA', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/apilable-workat1-1d037deda78bc62e9916505573779997-1024-1024.webp', 1, 71
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TAZA POLYMER MUG SUBLIMABLE', 'Comprá online TAZA POLYMER MUG SUBLIMABLE por $1.600. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/tazaa-recta-polimero-a0a2f010995909b78917473143683559-1024-1024.webp', 1, 72
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TELA TEFLONADA 40X40', 'Comprá online TELA TEFLONADA 40X40 por $11.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/tela-teflonda1-6e01290c87bcc4aaf015544675502282-1024-1024.webp', 1, 7
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TELA TEFLONADA 60X40', 'Comprá online TELA TEFLONADA 60X40 por $16.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/tela-teflonda11-6e01290c87bcc4aaf015544676415623-1024-1024.webp', 1, 8
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TERMO BAMBU SUBIMABLE', 'Aluminio sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-17-jul-2026-14_44_54-c04bd78f418700ce3917843103721796-1024-1024.webp', 1, 73
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TERMO LECHERO SUBLIMABLE', 'Aluminio sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-17-jul-2026-14_45_03-a4f6aa9e32ac8f628317843104047425-1024-1024.webp', 1, 74
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TERMO MATERO POLYMER MUG SUBLIMABLE', 'Comprá online TERMO MATERO POLYMER MUG SUBLIMABLE por $9.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/termo-a109861eb4a635d65617845607290510-1024-1024.webp', 1, 75
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TERMO TAZA SUBLIMABLE', 'Aluminio sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-17-jul-2026-14_44_56-e88aa3abfd234286d517843103885063-1024-1024.webp', 1, 76
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TIJERA GOLD DIARIA ADORIE', 'Compacta, elegante y funcional, es perfecta para tener siempre a mano y resolver cortes con prolijidad y estilo. ✂️ 16 cm de largo✨ Filo...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-25-feb-2026-16_32_02-53febd17a1729497cf17720492957678-1024-1024.webp', 1, 9
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TIJERA LAVANDA ADORIE', 'Delicada, cómoda y versátil, es perfecta para quienes buscan precisión con un toque de color y encanto. ✂️ 17 cm de largo💜 Detalle lavan...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-13-mar-2026-12_15_52-1e209ca2e9a7a5830117734149604109-1024-1024.webp', 1, 10
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TIJERA OLIVA DIARIA ADORIE', 'De diseño delicado y espíritu natural, combina precisión y comodidad para acompañarte en tus momentos creativos y tareas diarias. ✂️ 21,5 cm de ...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/chatgpt-image-25-feb-2026-16_32_51-5fc88580ff775baacb17720491745848-1024-1024.webp', 1, 11
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA FOTOGRAFICA ARTJET COMERCIAL 100CC AMARILLO', 'Comprá online TINTA FOTOGRAFICA ARTJET COMERCIAL 100CC AMARILLO por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/comercial-yellow1-e0234e7caa46cc0fd516928067435938-1024-1024.webp', 1, 0
FROM categories c
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA FOTOGRAFICA ARTJET COMERCIAL 100CC CIAN', 'Comprá online TINTA FOTOGRAFICA ARTJET COMERCIAL 100CC CIAN por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/comercial-cyan1-46766f2bb3636834d916928069064225-1024-1024.webp', 1, 1
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA FOTOGRAFICA ARTJET COMERCIAL 100CC MAGENTA', 'Comprá online TINTA FOTOGRAFICA ARTJET COMERCIAL 100CC MAGENTA por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/comercial-magenta1-80393059854f7eeca816928069571128-1024-1024.webp', 1, 2
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA FOTOGRAFICA ARTJET COMERCIAL 100CC NEGRO', 'Comprá online TINTA FOTOGRAFICA ARTJET COMERCIAL 100CC NEGRO por $3.000. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/comercial-negro1-e47b351edafd92c5ab16928066619781-1024-1024.webp', 1, 3
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA FOTOGRAFICA ARTJET PROFESIONAL 100CC AMARILLO', '', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-profesional-amarillo-x1001-f0023a44cc1f1e4a3c16615185122252-1024-1024.webp', 1, 4
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA FOTOGRAFICA ARTJET PROFESIONAL 100CC LIGHT CIAN', '', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-profesional-cyan-claro-x100-04dccb6796bc0426de17661659421968-1024-1024.webp', 1, 5
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA FOTOGRAFICA ARTJET PROFESIONAL 100CC LIGHT MAGENTA', '', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-profesional-magenta-claro-x100-1a128787ba92b0d19717661659238883-1024-1024.webp', 1, 6
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA SUBLIMACION ARTJET 100CC AMARILLO', '', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-sublimacion-amarillo1-5eb11efd1e8ee7a70a16747405755847-1024-1024.webp', 1, 7
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA SUBLIMACION ARTJET 100CC CIAN', '', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-sublimacion-cyan1-ac079e89311b388ca915902596794775-1024-1024.webp', 1, 8
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA SUBLIMACION ARTJET 100CC MAGENTA', '', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-sublimacion-magenta1-6778a1c083920c224a15902597242944-1024-1024.webp', 1, 9
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA SUBLIMACION ARTJET 100CC NEGRO', '', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-fotografico-profesional-negro1-35bae2b215ed21e74c15902595331336-1024-1024.webp', 1, 10
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTAS ART-JET: ¿CUÁL ES LA MEJOR PARA VOS?', 'Las tintas Art‑Jet están diseñadas para adaptarse a diferentes necesidades de calidad, resistencia y rendimiento. Te contamos sus diferencias para que ...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/imagen-de-whatsapp-2025-08-25-a-las-13-14-33_41aca659-5665fb01aaec8b1d4f17561385254478-1024-1024.webp', 1, 3
FROM categories c
WHERE c.name = 'APRENDE' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'VASO CON PICO POLYMER MUG SUBLIMABLE - AZUL', 'Vaso con Pico antivuelco. Dimensiones: 13,5 cm de alto x 8 cm de diámetro Capacidad: 400cc Espesor: 3 mm Color: Blanco , Tapa Rosa Temperatura y tiempo de su...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/vaso-con-pico-azul-bd873429ad89183edd17386764717726-1024-1024.webp', 1, 77
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'VASO CON PICO POLYMER MUG SUBLIMABLE ROSA', 'Vaso con Pico antivuelco. Dimensiones: 13,5 cm de alto x 8 cm de diámetro Capacidad: 400cc Espesor: 3 mm Color: Blanco , Tapa Rosa Temperatura y tiempo de su...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/vaso-con-pico-rosa-0562f4111ad496d9b517845612584464-1024-1024.webp', 1, 78
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'WINKY BLANCO A4 ARTJET - 1 HOJA', 'UNA EXPERIENCIA DE TRANSFORMACIÓN Imagina un material que convierte tus ideas en realidad con un toque de calor, un papel que se encoge y se moldea para da...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/winky-blanco-ef283ab3fd3610998716999723184323-1024-1024.webp', 1, 93
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'WINKY BLANCO A4 ARTJET - 10 HOJAS', 'UNA EXPERIENCIA DE TRANSFORMACIÓN Imagina un material que convierte tus ideas en realidad con un toque de calor, un papel que se encoge y se moldea para da...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/winky-blanco-de76df511ecfae7a0817853328243957-1024-1024.jpg', 1, 94
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'WINKY SEMITRANSPARENTE A4 ARTJET - 1 HOJA', 'UNA EXPERIENCIA DE TRANSFORMACIÓNImagina un material que convierte tus ideas en realidad con un toque de calor, un papel que se encoge y se moldea para dar v...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/winky-semi-b62d27fde048d7818617436850735733-1024-1024.webp', 1, 95
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'WINKY SEMITRANSPARENTE A4 ARTJET - 10 HOJAS', 'UNA EXPERIENCIA DE TRANSFORMACIÓNImagina un material que convierte tus ideas en realidad con un toque de calor, un papel que se encoge y se moldea para dar v...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/winky-semi-28c67faf09a0b23f9217853328847023-1024-1024.jpg', 1, 96
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, '¿QUÉ ES EL SUBLISTICK?', '¿Qué es el Sublistick? El Sublistick es un vinilo autoadhesivo especialmente diseñado para sublimación. A diferencia de otros adhesivos, este necesita un pro...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/imagen-de-whatsapp-2025-08-25-a-las-15-17-10_2cb890de-816747f4208323740517561458428952-1024-1024.webp', 1, 6
FROM categories c
WHERE c.name = 'APRENDE' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
-- ATRIL MADERA - CR20
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'ATRIL MADERA - CR20', 'Atril exhibidor - no sublimable', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/atril1-0cbbc9413681df70ea15544705246066-1024-1024.webp', 1, 79
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - MARINO MARINO MARINO', 'Comprá online GORRA TRUCKER - MARINO MARINO MARINO por $2.800. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/trucker-marino-abfe1eaf1dd85884fe17635704133763-1024-1024.webp', 1, 17
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'GORRA TRUCKER - NEGRO BLANCO NEGRO', 'vicera y red negro - frente blanco', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/trucker-negro-blanco1-64525470aa48fbee4715544701587166-1024-1024.webp', 1, 18
FROM categories c
WHERE c.name = 'GORRAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'MATELINA TEXTURADO A4 230G TRAMADO DE ALGODON ARTJET - 50 HOJAS', 'Comprá online MATELINA TEXTURADO A4 230G TRAMADO DE ALGODON ARTJET - 50 HOJAS por $11.600. Hacé tu pedido y pagalo online.', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/matelina-230g-tramado-de-algodon-50-hojas-650002f34810c6c06a17576908936710-1024-1024.webp', 1, 98
FROM categories c
WHERE c.name = 'PAPELES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PLACA TROFEO RECTANGULOS MADERA CRISTAL - CR218D', 'Medidas 10 x 16,5 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/placa-trofeo-rectangulo-822d27428a432737cb17211424546984-1024-1024.webp', 1, 80
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'PORTA SAHUMERIO MADERA CRISTAL - CR93', '26 cm x 6 cm', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/porta-sahumerio1-c0090d81dab44ee3bc15792066414864-1024-1024.webp', 1, 81
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'ROMPECABEZAS 30 PIEZAS MADERA CRISTAL - CR16', 'Dimensiones: 20 cm alto x 29 cm de ancho Espesor : 2.5 mm Color: Blanco Temperatura y tiempo de sublimación: 180° 30 seg Área de estampado: completo Super...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/rompecabeza-301-001c153444a52ae1dc15544888024116-1024-1024.webp', 1, 82
FROM categories c
WHERE c.name = 'SUBLIMABLES' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TIJERA BOTANICA ADORIE', 'En el Atelier donde cada hoja encuentra su lugar perfecto… nacen las Grampas 26/06 📎✨ Pensadas para el ritmo cotidiano, combinan practicidad y...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/gemini_generated_image_r23ti4r23ti4r23t-b0646a34858a3ffdac17746267549588-1024-1024.webp', 1, 12
FROM categories c
WHERE c.name = 'ACCESORIOS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA FOTOGRAFICA ARTJET ETERNITY GOLD EDITION 100CC AMARILLO', 'La tinta Eternity es una tinta Dye (tinta líquida a base de colorantes). Se usa en impresoras de inyección de tinta (inkjet). Protege tus fotos del sol y d...', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/eternity-am-bc9e35e15a2d99b26017840474290090-1024-1024.webp', 1, 11
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA FOTOGRAFICA ARTJET PROFESIONAL 100CC CIAN', '', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-profesional-cyan-x1001-1f42d580ec7dbe40e516615184515021-1024-1024.webp', 1, 15
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
...
INSERT INTO products(category_id, name, description, image_path, active, sort_order)
SELECT c.id, 'TINTA FOTOGRAFICA ARTJET PROFESIONAL 100CC MAGENTA', '', 'https://dcdn-us.mitiendanube.com/stores/049/818/products/artjet-profesional-magenta-x1001-e8700c3e82ba8f093d16615184839254-1024-1024.webp', 1, 16
FROM categories c
WHERE c.name = 'TINTAS' COLLATE NOCASE
  AND NOT EXISTS (
      SELECT 1 FROM products p
