...
use LaboratorioDigital\CustomerService;
...
use LaboratorioDigital\ReceptionAiService;
...
require_once __DIR__ . '/ReceptionAiService.php';
...
$app['reception_ai'] = new ReceptionAiService($app['config'], $app['settings']);
$app['customers'] = new CustomerService($app['pdo']);
